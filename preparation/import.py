...
HOBBIES = [
    "Reading books", "Blogging", "Dancing", "Singing", "Listening to music",
    "Playing musical instruments (piano, guitar etc.)", "Learning new languages", "Shopping",
    "Traveling", "Hiking", "Cycling", "Exercising", "Drawing", "Painting", "Collecting things",
    "Playing computer games", "Cooking", "Baking", "Gardening", "Doing crafts (handmade)",
    "Embroidering", "Sewing", "Knitting", "Playing board games", "Walking", "Writing stories",
    "Fishing", "Photography", "Skydiving", "Skating", "Skiing", "Roller skating", "Longboarding",
    "Surfing"
]
faker = Faker()
